...
var vida=0;
var cor_barra1 = 'rgb(0,255, 0)', cor_barra2 = 'rgb(0, 255, 0)', cor_barra3 = 'rgb(0,255, 0)'
...
function CriarElementos(){
    ...
    //Vidas
    c.fillStyle = cor_barra1
    c.fillRect(1.4*canvas.height, 5, 50, 10)

    c.fillStyle = cor_barra2
    c.fillRect(1.5*canvas.height, 5, 50, 10)

    c.fillStyle = cor_barra3
    c.fillRect(1.6*canvas.height, 5, 50, 10)
}
...
function AnimateCenario(){
    ...
    if((x == x_bigboss || x == x_bigboss - 5 || x == x_bigboss + 5 || x == x_bigboss - 10 || x == x_bigboss + 10|| x == x_bigboss - 15 || x == x_bigboss + 15 || x == x_bigboss - 20 || x == x_bigboss + 20 || x == x_bigboss - 25 || x == x_bigboss + 25) && plataforma == true && big_boss_derrotado == false){
        alert('Ah não, você foi derrotado pelo big boss')
        location.reload()
    }
    ...
    if(vida == 2){
        cor_barra2 = 'rgb(255, 0, 0)'
    }
    else if(vida == 3){
        cor_barra3 = 'rgb(255, 0, 0)'
        alert('Você perdeu!')
        vida = 0
        location.reload()
    }
